...
from ChadChamberAPI.utils.fields import PhoneField, PasswordField


class OptionsMetadata(SimpleMetadata):
    """
    A class for defining API metadata, taking into account the specifics of the fields.
    """
    # Dictionary for matching field classes and their types
    ...
    def determine_metadata(self, request, view):
        ...
        if serializer_list:
            actions_metadata = {}
            # Getting metadata for each action
    ...
    def get_serializer_info(self, serializer):
        """
        Getting information about the serializer.
        """
        fields = OrderedDict([
    ...
    def get_field_info(self, field):
        ...
        # Getting more information about the field
        attrs = [
        ...
        # Adding information about possible elections
